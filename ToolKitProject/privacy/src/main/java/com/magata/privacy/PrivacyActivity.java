...
public class PrivacyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int entryEnableResId = Utility.getRContent(this.getPackageName(), "bool", "privacy_unified_entry");

        Resources resources = getResources();
        boolean entryEnable = resources.getBoolean(entryEnableResId);

        Log.e(TAG, "onCreate: " + entryEnable);

        int titleArrResId = Utility.getRContent(this.getPackageName(), "array", "privacy_title_arr");
        final String[] titleArray = resources.getStringArray(titleArrResId);

        int contentArrResId = Utility.getRContent(this.getPackageName(), "array", "privacy_content_arr");
        final String[] contentArray = resources.getStringArray(contentArrResId);
            ...
            while (matcher.find()) {
                ...
                contentSpannableString.setSpan(new ClickableSpan() {
                    ...
                    public void onClick(View widget) {
                        ...
                        bundle.putString("title", titleArray[contentIndex]);
                        bundle.putString("contentHtml", contentArray[contentIndex]);
