...
namespace Com.Magata.Utility
{
    public class Utility
    {
        ...
        public bool StartActivity(string action, string url)
        {
            AndroidJavaClass utility = new AndroidJavaClass("com.magata.utility.Utility");
            bool result = utility.CallStatic<bool>("startActivity", currentActivity, action, url);
            utility.Dispose();

            return result;
        }

        public bool StartActivity(string action, string url, string mimeType)
        {
            AndroidJavaClass utility = new AndroidJavaClass("com.magata.utility.Utility");
            bool result = utility.CallStatic<bool>("startActivity", currentActivity, action, url, mimeType);
            utility.Dispose();

            return result;
        }

        public string GetIntentAction(string actionName)
        {
