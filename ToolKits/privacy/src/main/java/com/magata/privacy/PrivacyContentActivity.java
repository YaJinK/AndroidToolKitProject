...
public class PrivacyContentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int htmlUrlResId = Utility.getRContent(this.getPackageName(), "string", "privacy_html_url");
        String htmlUrl = getString(htmlUrlResId);
        content.loadUrl(htmlUrl + "/" + bundle.getString("contentHtml"));
    }
}
